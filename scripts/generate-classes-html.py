...
CLASSES = [
    ...
    },
    {
        ...
        "max_wd": 10,
        "key_ability": "Fitness (FIT) or Agility",
        "saves": "FIT, WIL",
    ...
    },
    {
        ...
        "features": [
            ...
            },
            {
                "name": "Unarmored Defense",
                "level": "1st-level feature",
                "text": "AC = 10 + Agility modifier + INS modifier while unarmored and without shield.",
            },
        ],
...
GLANCE_ROWS = [
    ["Barbarian", "12", "FIT", "FIT", "Martial"],
    ["Bard", "8", "WIL", "FIT, WIL", "Arcane"],
    ["Cleric", "8", "INS", "INS, WIL", "Divine"],
    ["Druid", "8", "INS", "INS, WIL", "Primordial"],
    ["Fighter", "10", "FIT/DEX", "FIT, WIL", "Martial"],
    ["Artificer", "8", "INS", "FIT, INS", "Martial/Tech"],
    ["Monk", "8", "DEX", "FIT, DEX", "Martial"],
    ["Paladin", "10", "FIT", "INS, WIL", "Divine/Martial"],
    ["Ranger", "10", "FIT/DEX", "FIT, DEX", "Primordial/Martial"],
    ["Rogue", "8", "DEX", "DEX, INS", "Martial"],
    ["Sorcerer", "6", "WIL", "FIT, WIL", "Arcane"],
    ["Warlock", "8", "WIL", "INS, WIL", "Arcane"],
    ["Wizard", "6", "INS", "INS, WIL", "Arcane"],
]
...
<main>
  ...
  <div class="content">
    ...
    <p>Subclass features arrive at <strong>2nd, 4th, 6th, and 8th</strong> level. Improvement (talents or ability increases) arrives at <strong>3rd, 5th, 7th, 9th, and 10th</strong> level. Casters use <a href="core.html#magic-and-spell-resources">Spell Power</a> and max spell circles per level instead of daily spell slots.</p>
