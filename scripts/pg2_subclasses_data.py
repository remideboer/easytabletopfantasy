        ...
        _sub(
            ...
            [
                _sf(cid, cname, "elemental-voice", "Elemental Voice", ["Elemental Voice Feature"], _ymiat_level_label("3rd"),
                    ...
                    "<p>Elemental Voice subclass features from Tales of the Valiant Player's Guide 2. Apply using YMIAT terminology (Wounds, Fitness/Insight/Willpower, spell circles).</p>"),
        ...
        _sub(
            ...
            [
                _sf(cid, cname, "seal-guardian", "Seal Guardian", ["Seal Guardian Feature"], _ymiat_level_label("3rd"),
                    ...
                    "<p>Seal Guardian subclass features from Tales of the Valiant Player's Guide 2. Apply using YMIAT terminology (Wounds, Fitness/Insight/Willpower, spell circles).</p>"),
        ...
        _sub(
            ...
            [
                ...
                _sf(cid, cname, "arrow-binder", "Arrow Binder", ["Bind Spell"], _ymiat_level_label("3rd"),
                    ...
                    "<p>As an action, you can expend a spell circle to cast a</p>"),
            ],
            TOV_PG2,
        ),
        _sub(
        ...
        _sub(
            ...
            [
                _sf(cid, cname, "con-arcanist", "Con Arcanist", ["Con Arcanist Feature"], _ymiat_level_label("3rd"),
                    ...
                    "<p>Con Arcanist subclass features from Tales of the Valiant Player's Guide 2. Apply using YMIAT terminology (Wounds, Fitness/Insight/Willpower, spell circles).</p>"),
        ...
        _sub(
            ...
            [
                ...
                _sf(cid, cname, "archon", "Archon", ["Restore Efficiency"], _ymiat_level_label("7th"),
                    ...
                    "<p>As a free action, you can expend a Wyrd spell circle of 1st circle or higher to end one condition or magical effect that affects you or a creature you touch. If the effect is the product of a spell equal to or less than the circle of the expended slot, it automatically ends. For effects created by spells of a circle higher than the expended slot, make a</p>"),
        ...
        _sub(
            ...
            [
                ...
                _sf(cid, cname, "arcanist", "Arcanist", ["Eidetic Scribe"], _ymiat_level_label("11th"),
                    ...
                    "<p>As a reaction when a creature that you can see and hear casts a spell from the Arcane source list, you can attempt to memorize it. Make an INT (Arcana) check with a DC of 10 + the spell\u2019s circle. On a success, you can cast that spell as though you have it prepared until you finish a short or long rest.</p>"),
                _sf(cid, cname, "arcanist", "Arcanist", ["Mastered Spell"], _ymiat_level_label("15th"),
                    ...
                    "<p>As part of a long rest, you can select one non\u2011ritual spell of 3rd circle or lower that you have scribed within your spellbook and master it. That spell is always prepared for you and doesn\u2019t count against the number of spells you can prepare. You can cast that spell at its lowest circle without expending a spell slot, though you must still supply any spell components.</p>"),
            ],
            TOV_PG2,
        ),
        _sub(
        ...
        _sub(
            ...
            [
                ...
                _sf(cid, cname, "summoner", "Summoner", ["Master Summoner"], _ymiat_level_label("7th"),
                    ...
                    "<p>You can have one additional spell from your Rote Spell feature (see Player\u2019s Guide) per spell circle for which you already have a rote spell. These extra rote spells must be spells from the conjuration school that create or summon one or more creatures.</p>"),
